...
## 🎯 Business Question
Which advertising channel attracts paying users more cheaply and efficiently for the delivery service business?

## 🔍 SQL Query
```sql
WITH valid_orders AS (
    -- Orders that have not been canceled
...
- Targeted advertising attracts paying users cheaper.
- With the same budget, we get more real value.
- Campaign No. 2 looks more effective in terms of unit economics at the recruitment stage.

Despite the fact that targeted advertising showed a lower CAC (-27%), LTV and retention must be taken into account to make a final assessment of the effectiveness of the channel. 
In delivery services, the key is not the cost of the first order, but repeat purchases and the frequency of orders.